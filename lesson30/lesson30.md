...
Мережеві порти успішно налаштовано. В ідеалі, можна було б обмежити доступ до порту 22 лише для конкретної ip-адреси, але ми залишимо доступ для всіх
...
Оскільки в нас тестовий стенд, щоб уникнути потенційних фінансових проблем, зупиняємо і видаляємо всі створені нами ресурси.
